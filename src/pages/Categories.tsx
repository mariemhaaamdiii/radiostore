...
const Categories: React.FC = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      // Handle specific error for category in use
  ...
  return (
    <Layout title="Categories">
      ...
      <ConfirmDialog
        ...
        message={`Are you sure you want to delete "${selectedCategory?.name}"? This action cannot be undone. Products with this category will be affected.`}
        confirmText="Delete"
        cancelText="Cancel"
        variant="danger"
